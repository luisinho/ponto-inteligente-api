...
public class LancamentoRepositoryTest {
	...
	public void setUp() throws Exception {
		...
		Funcionario funcionario = this.funcionarioRepository.save(this.obterDadosFuncinario(empresa));
	...
	private Funcionario obterDadosFuncinario(Empresa empresa)  throws NoSuchAlgorithmException {
